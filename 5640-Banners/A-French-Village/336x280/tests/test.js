...
describe("zipfile", function() {
    it("should be under /Users/dq212/Documents/CLIENTS/o2kl/MHz/Banners/5640-Banners/A-French-Village/336x280/node_modules/.bin/resize-bannekb", function() {
        var zip = fs.statSync("../HTML/5640_MHz_A-French-Village_Banner_336x280.zip");
...
describe("static image", function() {
    it("should match dimensions of the creative", function() {
        ...
        expect(dimensions.width).toBe(
            336,
            "\nIncorrect width on the static image. It should be 336px wide"
        );
        expect(dimensions.height).toBe(
            280,
            "\nIncorrect height on the static image. It should be 280px tall"
        );
    });
});
