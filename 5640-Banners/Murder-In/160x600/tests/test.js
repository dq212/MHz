...
describe("zipfile", function() {
    it("should be under /Users/dq212/Documents/CLIENTS/o2kl/MHz/Banners/5640-Banners/Murder-In/160x600/node_modules/.bin/resize-bannekb", function() {
        var zip = fs.statSync("../HTML/5640_MHz_Murder_In_160x600.zip");
...
describe("static image", function() {
    it("should match dimensions of the creative", function() {
        ...
        expect(dimensions.width).toBe(
            160,
            "\nIncorrect width on the static image. It should be undefinedpx wide"
        );
        expect(dimensions.height).toBe(
            600,
            "\nIncorrect height on the static image. It should be undefinedpx tall"
        );
    });
});
